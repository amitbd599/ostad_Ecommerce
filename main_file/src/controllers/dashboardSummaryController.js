...
exports.dashboardSummary = async (req, res) => {
    try {
        ...
        // Filtered counts
        const pendingDeliver = await invoiceModel.countDocuments({ deliver_status: "pending" });
        const deliveredOrders = await invoiceModel.countDocuments({ deliver_status: "delivered" });
        const canceledOrders = await invoiceModel.countDocuments({ deliver_status: "cancel" });
